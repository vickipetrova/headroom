...
This Code of Conduct applies within all community spaces — this repository's issues, pull requests,
discussions and commit history — and also applies when an individual is officially representing the
...
Anything that does not need to be private can be raised in an issue.

Reports involving GitHub-wide behaviour can also go to
[GitHub Support](https://support.github.com/contact/report-abuse), which can act where a single
repository's maintainer cannot.

All complaints will be reviewed and investigated promptly and fairly. Community leaders are obligated
